# Google Play ASO Copy

App Store Optimization for the Play Store listing. Built around the Filipino-specific keywords that nobody else can rank for: **bisaklat, sietepares, sagasa, joker mahjong, 17 tile, filipino mahjong, mahjong pilipino**.

These are low-volume but ultra-high-intent — anyone searching "bisaklat" on the Play Store is your exact customer.
...
Alt option if A/B testing later:
- `Pinoy Mahjong: Joker Rules` (26)
- `Filipino Mahjong - 17 Tile` (26)

Stick with the current one. "Filipino" outranks "Pinoy" for non-Filipino searches and "Joker Rules" is the differentiator.

---

## Short description (max 80 characters)

**Authentic Pinoy mahjong with Jokers, Bisaklat, 17 tiles. Free, no sign-up.**
*(74 chars)*
...
```
The way Pinoys play at home — finally on your phone.
...
★ Joker Tiles — The signature wildcard mechanic, missing from international apps. Substitutes for any suit (Balls, Characters, Bamboos).
...
• Pinoys who grew up around the family mahjong table
• Filipino diaspora missing home — wherever you are in the world
• Mahjong fans curious about the Filipino variant
• Anyone who wants to learn what their lola was actually playing all those Sundays
...
**Tier 1 — must rank for these (low competition, high intent, exact match):**
- bisaklat
- sietepares / siete pares
- sagasa
- todas mahjong
- escalera mahjong
- mahjong pilipino
...
**Tier 3 — long tail (low priority, only mention once):**
- mahjong with jokers
- single player mahjong
- offline mahjong free
- mahjong simulator
- mahjong solitaire (different game but cross-traffic)

---

## Screenshots (8 slots — what each should be)

The Play Store gives you 8 screenshot slots. Order matters: first 3 show before the user has to tap "more."

Recommended order:

1. **Hero shot with text overlay** — gameplay screenshot with "AUTHENTIC FILIPINO RULES" overlay in your gold-on-blue Cinzel style
2. **Bisaklat moment** — show a Bisaklat win with "BISAKLAT — Win on the first draw" overlay
3. **Joker tile reveal** — gameplay shot featuring a Joker, with "JOKERS — The wildcard tile other apps don't have"
4. **The full table** — wide gameplay view, with overlay "17 TILES • THREE OPPONENTS"
...
## Reviews strategy (first 30 days)

**The first 20 reviews matter more than the next 200.**

Day 1: Text 30 friends/family personally. Ask them to download AND leave a written review (not just a star rating). Even 5-10 honest reviews in week 1 changes how Google's algorithm classifies your app.

Don't ask for 5-stars. Ask for honest reviews. Honest reviews from real users will average 4.5+ if the game is good, and Google trusts the variance more than uniform 5-stars.

**Reply to every review** — positive AND negative — in the first 30 days. Reply rate is a public ranking signal.
